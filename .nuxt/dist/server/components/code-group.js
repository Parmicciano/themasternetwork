...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "button[data-v-67ddf998]{outline:none}.highlight-underline[data-v-67ddf998]{--bg-opacity:1;background-color:#00cd81;background-color:rgba(0,205,129,var(--bg-opacity));position:absolute;bottom:-2px;height:2px;transition:left .15s,width .15s}.code-group[data-v-67ddf998]  pre[class*=language-]{border-top-left-radius:0;border-top-right-radius:0;margin-top:0}", ""]);
// Exports
